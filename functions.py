...
def is_divisible_by_three(numbers):
    return numbers % 3 == 0
...
#    greeting.
def write_letter(title, RECIPIENT_NAME, SENDER_NAME):
    reciever = full_title(title, RECIPIENT_NAME)
    print(f"Dear {reciever}, I think you are amazing! Sincerely, {SENDER_NAME}")
