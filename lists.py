...
def n_long_words(words, n):
    ...
    return [char for char in words if len(char) > n]
...
def smallest_int(numbers):
    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    small_num = None
    for nums in numbers:
        if small_num is None or nums < small_num:
            small_num = nums
    return small_num
...
def halvesies(numbers):
    ...
    """
    #half_the_number = []
    return [nums/2 for nums in numbers]
        #    half_the_number.append(nums)
